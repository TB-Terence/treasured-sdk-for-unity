...
namespace Treasured.UnitySdk
{
    internal class AboutWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (EditorGUILayoutUtilities.Link(new GUIContent("Website"), new GUIContent("https://treasured.ca/")))
            {
                Application.OpenURL("https://treasured.ca/");
            }
            if (EditorGUILayoutUtilities.Link(new GUIContent("Email"), new GUIContent("team@treasured.ca")))
            {
