...
Open Unity and select ***Window -> Package Manager*** on the toolbar. Click on the **+** icon on the top left corner. Select ***Add package from git URL***, then paste https://github.com/TB-Terence/treasured-sdk-for-unity.git and click **Add**.
