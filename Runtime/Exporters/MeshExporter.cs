...
namespace Treasured.UnitySdk
{
    public class MeshExporter : Exporter
    {
        ...
        private void CreateGLB(Transform[] export)
        {
            ...
            if (!string.IsNullOrEmpty(Path.Combine(TreasuredSDKPreferences.Instance.customExportFolder, Map.projectFolder, ".treasured", Map.projectFolder)))
            {
                exporter.SaveGLB(Path.Combine(TreasuredSDKPreferences.Instance.customExportFolder, Map.projectFolder, ".treasured", Map.projectFolder).ToOSSpecificPath(), "scene");
            }
        }
